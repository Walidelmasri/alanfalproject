                                  ...
                                  child: MaterialButton(
                                    onPressed: () async{
                                      if(_formKey.currentState.validate()){
                                        if(!await user.signUp(_name.text ,_email.text, _password.text, _phonenumber.text, _address.text)){
                                          _key.currentState.showSnackBar(SnackBar(content: Text("Sign Up failed")));
                                          return;
                                        }
                                        _key.currentState.showSnackBar(SnackBar(content: Text('Sign Up Succeeded'),));
